var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	var navigator = new Navigator({ props: { route: ctx.$routes[`/`] } });
    ...
    function create_if_block$1(ctx) {
    	...
    	var router = new Router({ props: { deep: ctx.deep } });
    ...
    function create_fragment$7(ctx) {
    	...
    	var navigator = new Navigator({ props: { route: ctx.$routes[`/`][`root-routes`] } });
    ...
    class RootRoutes extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    class Route6 extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    function create_fragment$b(ctx) {
    	...
    	var router = new Router({ props: { deep: true } });
    ...
    class NestedRoutes extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    function create_fragment$c(ctx) {
    	...
    	var navigator = new Navigator({ props: { route: ctx.$routes[`/`][`wildcard`] } });
